    ...
    <div class="card card-login mx-auto mt-5">
      ...
      <div class="card-body">
        <div class="text-center mt-4 mb-5">
          <h4>
Esqueceu sua senha?</h4>
          <p>Digite seu endereço de e-mail e nós lhe enviaremos instruções sobre como redefinir sua senha.</p>
        </div>
        <form action="envio_email.php" method="post" role="form">
          <div class="form-group">
            <input class="form-control" id="exampleInputEmail1" type="email" aria-describedby="emailHelp" placeholder="Digite seu email" name="email" autofocus>
          </div>
