    ...
    <div class="card card-login mx-auto mt-5">
      ...
      <div class="card-body">
        <div class="text-center mt-4 mb-5">
          <h4>
Recebemos sua solicitação com sucesso!</h4>
          <p>Dentro de alguns instantes você receberá em seu e-mail instruções para gerar uma nova senha, verifique a caixa de spams.</p>
        </div>
